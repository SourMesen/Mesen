...
std::unordered_map<string, string> MessageManager::_zhResources = {
	...
	{ "CouldNotInitializeAudioSystem", u8"无法初始化声音系统" },
	...
	{ "KeyboardModeDisabled", u8"K键盘模式已禁用." },
	{ "KeyboardModeEnabled", u8"键盘模式已启用." },
	{ "Lag", u8"延迟" },
	{ "Mapper", u8"映射器: %1, 副映射器: %2" },
	{ "MovieEnded", u8"影片已结束." },
	{ "MovieInvalid", u8"电影文件无效." },
	{ "MovieMissingRom", u8"丢失所需的ROM(%1)来播放电影." },
