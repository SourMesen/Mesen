			...
			try {
				...
				try {
					...
					switch(ResourceHelper.GetCurrentLanguage()) {
						...
						case Language.German: message = "Microsoft .NET Framework 4.5 konnte nicht gefunden werden. Bitte die aktuellste .NET-Framework-Version von der Microsoft-Website herunterladen und erneut versuchen."; break;
					}
					...
					switch(ResourceHelper.GetCurrentLanguage()) {
						...
						case Language.German: message = "Ein unerwarteter Fehler ist aufgetreten.&#xA;&#xA;Details zum Fehler:&#xA;{0}"; break;
					}
