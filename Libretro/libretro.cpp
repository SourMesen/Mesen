...
#define MesenNtscFilter "mesen_ntsc_filter"
#define MesenPalette "mesen_palette"
#define MesenNoSpriteLimit "mesen_nospritelimit"
#define MesenOverclock "mesen_overclock"
#define MesenOverclockType "mesen_overclock_type"
#define MesenOverscanVertical "mesen_overscan_vertical"
#define MesenOverscanHorizontal "mesen_overscan_horizontal"
#define MesenAspectRatio "mesen_aspect_ratio"
#define MesenRegion "mesen_region"
#define MesenRamState "mesen_ramstate"
#define MesenControllerTurboSpeed "mesen_controllerturbospeed"
#define MesenFdsAutoSelectDisk "mesen_fdsautoinsertdisk"
#define MesenFdsFastForwardLoad "mesen_fdsfastforwardload"
#define MesenHdPacks "mesen_hdpacks"
#define MesenScreenRotation "mesen_screenrotation"
#define MesenFakeStereo "mesen_fake_stereo"
#define MesenMuteTriangleUltrasonic "mesen_mute_triangle_ultrasonic"
#define MesenReduceDmcPopping "mesen_reduce_dmc_popping"
#define MesenSwapDutyCycle "mesen_swap_duty_cycle"
#define MesenDisableNoiseModeFlag "mesen_disable_noise_mode_flag"
...
extern "C" {
	...
	void set_flag(const char* flagName, uint64_t flagValue)
	{
		...
		var.key = flagName;
		var.value = "";
		if(retroEnv(RETRO_ENVIRONMENT_GET_VARIABLE, &var) && var.value) {
